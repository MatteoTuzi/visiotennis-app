                    ...
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">
                                Partita più veloce: player_1 vs player_2
                            </h4>
                            <div class="text-gray-500">
                                <!-- {{ gameStore.fastestGame.attributes.match_end_time }} non va ancora-->
                ...
                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                        ...
                        <div class="mx-5">
                            ...
                            <div class="text-gray-500">
                                {{ gameStore.gameList.data?.length }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            <tr v-for="(game, index) in gameStore.gameList.data" :key="index">
...
export default defineComponent({
    ...
    methods: {
        async getGames() {
            ...
            console.log(this.gameStore.gameList)
        },
    },
